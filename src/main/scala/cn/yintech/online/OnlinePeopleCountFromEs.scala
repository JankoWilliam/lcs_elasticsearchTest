...
import java.util
import java.util.{Date, List, TimeZone}
...
//    ssc.checkpoint("./updateStateByKey")
      ...
      val realTimeData = data
        ...
        .filter(v => v._1 != "" && v._1 != null && v._2 != "" && v._4 == "1" && (v._3 == "圈子视频直播" || v._3 == "圈子文字直播" || v._3 == "大直播"))
        // (extra_id,文字直播/视频直播/大直播,uid,c_time)
        .map(v => (v._1, v._3, v._2, v._5)).cache()



      val realTimeWindow = realTimeData.window(Seconds(30)).cache()
